...
when you run the program by giving you a local address in the console. Pasting the URL into the web browser will allow you to play.

The game is fully functional, and I plan on coming back to this to add new features, but as of now the game works as follows:
Given a random word, using the letters of that word, create all words that can be made using those letters. Find all to win!
